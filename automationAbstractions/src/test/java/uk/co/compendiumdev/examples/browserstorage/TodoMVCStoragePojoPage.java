...
/*
    Copied from TodoMVCPojoPage to keep tests localised
 */
public class TodoMVCStoragePojoPage {
    ...
    public TodoMVCStoragePojoPage(WebDriver driver, String url) {
        this.driver = driver;
        this.url = url;
    ...
    public void enterNewToDo(final String keysToSend) {
        WebElement createTodo = driver.findElement(By.className("new-todo"));
        createTodo.click();
        createTodo.sendKeys(keysToSend);
